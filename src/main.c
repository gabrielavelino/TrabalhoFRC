...
int max_file_descriptors, socket_file_descriptor, new_file_descriptor, file_descriptor, j, yes = 1;
socklen_t addrlen;
...
void broadcast_message(char message[256], int message_length)
{
